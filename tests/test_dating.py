...
test-pdc.R. Formula-exact checks use pytest.approx with a tight
tolerance (matches this project's convention in test_datestamp.py etc.);
Monte Carlo checks use loose bounds, per the same finite-sample honesty
this family's R tests document (see docs/dating-and-root-inference.md)."""
