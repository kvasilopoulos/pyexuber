...
# `badf` shape) instead of a single full-sample test. Only QPWY (single
# recursion) is implemented, not QPSY (their double recursion, additionally
# optimizing over the window start too -- O(T^2) QR fits, not attempted).
#
